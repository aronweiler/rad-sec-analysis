...
class AgenticToolManager(ErrorRecoveryMixin):
    ...
    async def initialize_tools(
        self, stage_config, required_tools: Optional[List[str]] = None
    ):
        """
    ...
    async def execute_tools(
        ...
        for tool_call in response.tool_calls:
            ...
            if is_mcp_tool:
                ...
                result, tool_termination_result, validation_error = (
                    await self._execute_langchain_tool(
    ...
    async def _execute_langchain_tool(
        ...
        try:
            ...
            if tool_name in termination_tool_names:
                ...
                self.logger.info(
                    f"Termination tool '{tool_name}' executed successfully"
                )
